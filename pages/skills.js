    ...
    return (
        <div className='site-container'>
            <div className='skills-container'>
                ...
                <div className='rate-card'><Skill skill="Java" rate={4} icon={<FontAwesomeIcon size="4x" icon={faJava} />} /></div>
                <div className='rate-card'><Skill skill="Python" rate={4} icon={<FontAwesomeIcon size="4x" icon={faPython} />} /></div>
                <div className='rate-card'><Skill skill="React" rate={4} icon={<FontAwesomeIcon size="4x" icon={faReact} />} /></div>
                <div className='rate-card'><Skill skill="Vue" rate={4} icon={<FontAwesomeIcon size="4x" icon={faVuejs} />} /></div>
